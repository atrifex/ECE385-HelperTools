...
palette_hex = ['0x000000', '0xF83800', '0xF0D0B0', '0x503000', '0xFFE0A8', '0x0058F8', '0xFCFCFC', '0xBCBCBC', '0xA40000', '0xD82800', '0xFC7460', '0xFCBCB0', '0xF0BC3C', '0xAEACAE', '0x363301', '0x6C6C01', '0xBBBD00', '0x88D500', '0x398802', '0x65B0FF', '0x155ED8', '0x800080', '0x24188A']
...
outFile = open("./sprite_bytes/" + filename.split('/')[1][:-4] + '.txt', 'w')
i = 0
for y in range(im.size[1]):
    for x in range(im.size[0]):
        ...
        print(pixel)
        if(pixel[3] < 200):
            outImg.putpixel((x,y), palette_rgb[21])
            outFile.write("%x\n" % (21))
            print(i)
        else:
        ...
        i += 1
outFile.close()
outImg.save("./sprite_converted/" + filename.split('/')[1])
